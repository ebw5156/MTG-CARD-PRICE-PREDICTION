...
gl_model_1<-cv.glmnet(train_1, train_1y, alpha = 1,family="gaussian",alignment = "lambda",type.measure="deviance",nfolds = 10,gamma = 0.5)
error_DT<-NULL
...
gl_model_2<-glmnet(train_2, train_2y, alpha = 1,family="gaussian", alignment = "lambda",type.measure="deviance",nfolds = 10,gamma = 0)
...
gl_model_3<-glmnet(train_3, train_3y, alpha = 1,family="gaussian",alignment = "lambda",type.measure="deviance",nfolds = 10,gamma = 1)
